...
if(!d){var n=t.which,i=f[t.type];"pointer"===i&&(i=$(t));var o="keyboard"===i&&n&&-1===c.indexOf(n)||"mouse"===i||"touch"===i;if(a!==i&&o&&(a=i,window.sessionStorage&&window.sessionStorage.setItem("what-input",a),y("input")),l!==i&&o){
// preserve intent for keyboard typing in form fields
var r=document.activeElement,s;r&&r.nodeName&&-1===u.indexOf(r.nodeName.toLowerCase())&&(l=i,window.sessionStorage&&window.sessionStorage.setItem("what-intent",l),y("intent"))}}},y=function e(t){n.setAttribute("data-what"+t,"input"===t?a:l),C(t)},b=function e(t){
// only execute if the event buffer timer isn't running
// or scrolling isn't happening
if(
// test to see if `mousemove` happened relative to the screen to detect scrolling versus mousemove
T(t),!d&&!s){var n=f[t.type];"pointer"===n&&(n=$(t)),l!==n&&(l=n,window.sessionStorage&&window.sessionStorage.setItem("what-intent",l),y("intent"))}},w=function e(t){t.target.nodeName?(i=t.target.nodeName.toLowerCase(),n.setAttribute("data-whatelement",i),t.target.classList&&t.target.classList.length&&n.setAttribute("data-whatclasses",t.target.classList.toString().replace(" ",","))):
